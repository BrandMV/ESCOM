...
/*
	...
	Este programa muestra el algoritmo de ordenación burbuja optimizada 2 para hacer la medición de tiempos
...
{	
	...
	/*
		...
		indica si se realizaron o no cambios al hacer una interacción con 
		lo que podemos evitar realizar iteraciones de más una vez que el 
