...
/*
	...
	Este programa muestra el algoritmo de ordenación burbuja optimizada 1 para hacer la medición de tiempos
...
{	
	...
	//******************************************************************	
	//Algoritmo BUrbuja Optimizada 1
	/*
		Este algoritmo es parecido al de la burbuja simple, solo que con una pequeña modificación;
		conforme se van ordenando los elementos, el elemento mayor queda en su posición correcta, por lo que no es
		necesario volver a realizar la comparacion de este elemento con otro mas, esto lo hacemos en el segundo for
		al indicar que se haga la comparacion hasta n-2, pero restando la comparacion que ya no se hara.
		Este algoritmo recibe el arreglo en desorden y lo devuelve ordenado.
	*/
	//******************************************************************	
	for(i=0;i<n-1;i++)
		for(j=0;j<(n-1)-i;j++){
