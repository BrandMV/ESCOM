...
/*
	...
	Este programa muestra el algoritmo de ordenación por inserción para hacer la medición de tiempos
...
{	
	...
	int temp = 0; //varibale auxiliar para el algoritmo 
	//******************************************************************	
	...
	//Algoritmo inserción
	/*
	Cuando hay k elementos en una lista, se toma el elemento k+1 y se compara con todos los elementos a su
    derecha, de modo que cuando encuentra uno menor o cuando ya no se encuentran elementos, se inserta el elemento.
    */
	//******************************************************************	
