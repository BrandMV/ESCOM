...
public class SimpleProxyServer {
  ...
  public static void main(String[] args) throws IOException {
    try {
      ...
      /*CPG*/ if (args.length != 4) // argumentos: ip-host-remoto puerto-remoto puerto-local puerto-host-remoto
      ...
      /*CPG*/ // System.out.println("Starting proxy for " + host + ":" + remoteport +
      /*CPG*/ //                   " on port " + localport);
      /*CPG*/ System.out.println("Iniciando SimpleProxyServer: " + host + ":" + remoteport + " on port " + localport);
      ...
      System.err.println("Usage: java SimpleProxyServer " +
                         ...
                         /*CPG*/ "<ip-host-remoto> <puerto-servidor-remoto> <puerto-proxy-local> <puerto-servidor-local>");
    }
  }
