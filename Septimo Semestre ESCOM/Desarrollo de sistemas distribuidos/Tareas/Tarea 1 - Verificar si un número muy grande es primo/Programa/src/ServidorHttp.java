    ...
    static class Worker extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                /**Si la petición es get y es para verificar que un numero es primo entramos*/
                if(s.startsWith("GET /primo?")){
                    ...
                    for(int i = 0; i < 4; i++){
                        ...
                        /**Si encontramos un número que divide al número el número no es primo*/
                        if(entradaSocket.readInt() > 0){
                            ...
                            salida.flush();
                        }else{ /**Si no encontramos un número que divide al número, es primo*/
        ...
        /***
         * Método que obtiene el número a verificar a través de los parametros de la petición http
         * @param peticion La petición http que se hace
         * @return El número obtenido de los parametros
         */
